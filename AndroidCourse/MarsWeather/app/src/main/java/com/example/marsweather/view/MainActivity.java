...
import com.example.marsweather.viewmodel.MarsWeatherModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public MarsWeatherModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(MarsWeatherModel.class);

...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Contact> populateList() {
        ...
        Contact contact1 = new Contact("Batman", "Hero", R.drawable.ic_android);
        ...
        Contact contact4 = new Contact("Batman", "Hero", R.drawable.ic_android);
        ...
        Contact contact7 = new Contact("Batman", "Hero", R.drawable.ic_android);
